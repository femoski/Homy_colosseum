...
import 'package:homy/screens/location/widgets/location_search_dialog.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          ) : Text('search_location'.tr, style: Get.textTheme.bodyMedium!.copyWith(color: Theme.of(context).disabledColor)),
          const SizedBox(width: Dimensions.paddingSizeExtraSmall),

          Expanded(
            child: (pickedAddress != null && pickedAddress!.isNotEmpty) ? Text(
              pickedAddress!,
              style: Get.textTheme.bodyMedium!.copyWith(fontSize: Dimensions.fontSizeLarge), maxLines: 1, overflow: TextOverflow.ellipsis,
            ) : Text(
              hint ?? '',
              style: Get.textTheme.bodyMedium!.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
