  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          Get.toNamed('/property-details/${property.id}', arguments: {
                    ...
                    child: Stack(
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(15),
                          child: Ui.getImage(
                            property.media?.isNotEmpty == true && property.media!.first.content != null 
                                ? property.media!.first.content! 
                                : "",
                            height: 147,
                            width: double.infinity,
                            fit: BoxFit.cover,
                            // blurHash: property.media?.first.blurHash ?? "",
                          ),
                        ),
                                ...
                                child: Center(
                                  child: Text(
                                    property.propertyType!
                                      ...
                                      .bold()
                                      .size(context.theme.textTheme.titleSmall!.fontSize!).fontFamily("roboto"),
                                ),
                              ),
                            ),
                          ),
