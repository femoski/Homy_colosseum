...
class MyPropertyTab extends StatelessWidget {
  final MyPropertiesScreenController controller;

  const MyPropertyTab({super.key, required this.controller});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<MyPropertiesScreenController>(
      // id: controller.uPropertyIDs,
      init: controller,
      builder: (controller) {
        Get.log('controller.propertyType: ${controller.propertyType}');
        return Container(
          height: 40,
          width: Get.width,
