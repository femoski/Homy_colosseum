...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({super.key, this.onPressed, required this.buttonText, this.transparent = false, this.margin, this.width, this.height,
    this.fontSize, this.radius = 10, this.icon, this.color, this.textColor, this.isLoading = false, this.isBold = true, this.textStyle});
    ...
    return Center(child: SizedBox(width: width ?? Dimensions.webMaxWidth, child: Padding(
      ...
      child: TextButton(
        ...
        Center(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('Loading'.tr, style: Get.textTheme.bodyMedium!.copyWith(color: Colors.white, fontSize: fontSize)),
        ]),
          ...
          Text(buttonText, textAlign: TextAlign.center, style: textStyle ?? Get.textTheme.bodyMedium!.copyWith(
